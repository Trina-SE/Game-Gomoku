...
class GoMokuUI():
    ...
    def __init__(self, size:int, mode="PlayerVsAI"):
        ...
        self.restart_button = pygame.Rect(100, self.height - 50, 200, 40)
    ...
    def update(self):
        ...
        if self.mode == PVA:
            ...
            if self.game.isTurnOfBlack:
                ...
                self.game.handleAI(Player.WHITE)
        self.game.scoreOfBlack = GameEngine.getScore(self.game.board, True, not self.game.isTurnOfBlack)
        self.game.scoreOfWhite = GameEngine.getScore(self.game.board, False, not self.game.isTurnOfBlack)

    
    def draw(self):
        self.screen.fill((255, 255, 255))
        # self.screen.blit(self.font.render("FPS: {0:.2F}".format(self.clock.get_fps()), True, (0, 0, 0)), (10, 10))
        self.screen.blit(self.font.render("Black: {0}".format(self.game.scoreOfBlack), True, (0, 0, 0)), (100, self.height - 75))
        self.screen.blit(self.font.render("White: {0}".format(self.game.scoreOfWhite), True, (0, 0, 0)), (100, self.height - 100))
        ...
        self.screen.blit(self.font.render("Turn: {0}".format("Black" if self.game.isTurnOfBlack else "White"), True, (0, 0, 0)), (100, self.height - 125))
